...
from flask import render_template, url_for, request, g, jsonify, current_app, flash, redirect
...
from app.main.forms import PostForm, EditProfileForm, EmptyForm, SearchForm
